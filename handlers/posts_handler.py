...
api_limit_for_posts_resource = ApiLimitDependency(
...
def all_posts(
    ...
    limit: Annotated[ApiLimitDependency, Depends(api_limit_for_posts_resource)],
    page: int = 1,
):
    if page < 1:
        page = 1
...
async def create_post(
    ...
    image: Annotated[UploadFile, Form()] = None,
