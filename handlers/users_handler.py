...
get_user_api_limit = ApiLimitDependency(req_count=ApiLimitMode.PANDA.value)
@router.get("/{id}", response_model=schemas.UserOut)
def get_user(db :  db_dependency, id: int, request: Request, rds: rds_dependency, limit : Annotated[ApiLimitDependency, Depends(get_user_api_limit)]):
